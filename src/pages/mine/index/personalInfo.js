        ...
        return (
            <View style={styles.InfoOuter}>
                ...
                <View style={styles.releationNet}>
                    ...
                    <Text style={styles.netPersonNum}>{info.allFriendsCount || 0}</Text>
                </View>
                <View style={styles.hobbyWrapper}>
                    <View style={styles.hobbyInner}>
                        ...
                        {get(info,'hobbyTagNameList',[]).map(item => {
                            return (<Text style={styles.hobbyItem}  key={item}>{item}</Text>)
                        })}
                    </View>
                </View>
                <View style={styles.userProfile}>
                    ...
                    />
                    <Text style={styles.location}>【{info.cityName}】</Text>
